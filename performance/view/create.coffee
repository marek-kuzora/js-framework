...
performance 'parent'
  ...
  before: ->
    @prefix = 'fierry-pfc/view/create/p'
...
performance 'value'
  ...
  before: ->
    @prefix = 'fierry-pfc/view/create/v'
...
performance 'if'
  ...
  before: ->
    @prefix = 'fierry-pfc/view/create/i'
...
performance 'for'
  ...
  before: ->
    @prefix = 'fierry-pfc/view/create/f'
...
performance 'use'
  ...
  before: ->
    @prefix = 'fierry-pfc/view/create/u'
